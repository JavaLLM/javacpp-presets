...
public static final int GGUF_VERSION = 2;
...
// Targeting ../ggml_opt_context.java
    ...
    public static final int
        ...
        GGUF_TYPE_COUNT = 13;       // marks the end of the enum
...
// Targeting ../gguf_init_params.java
    ...
    public static native void gguf_set_val_u64(gguf_context ctx, @Cast("const char*") BytePointer key, @Cast("uint64_t") long val);
    public static native void gguf_set_val_u64(gguf_context ctx, String key, @Cast("uint64_t") long val);
    public static native void gguf_set_val_i64(gguf_context ctx, @Cast("const char*") BytePointer key, @Cast("int64_t") long val);
    public static native void gguf_set_val_i64(gguf_context ctx, String key, @Cast("int64_t") long val);
    public static native void gguf_set_val_f64(gguf_context ctx, @Cast("const char*") BytePointer key, double val);
    public static native void gguf_set_val_f64(gguf_context ctx, String key, double val);
...
public static final int GGML_METAL_MAX_BUFFERS = 16;
public static final int GGML_METAL_MAX_COMMAND_BUFFERS = 32;

// #ifdef __cplusplus
// Targeting ../ggml_metal_context.java



// number of command buffers to use
public static native ggml_metal_context ggml_metal_init(int n_cb);
public static native void ggml_metal_free(ggml_metal_context ctx);

public static native Pointer ggml_metal_host_malloc(@Cast("size_t") long n);
public static native void ggml_metal_host_free(Pointer data);

// set the number of command buffers to use
public static native void ggml_metal_set_n_cb(ggml_metal_context ctx, int n_cb);
...
//
public static native @Cast("bool") boolean ggml_metal_add_buffer(
        ggml_metal_context ctx,
                       @Cast("const char*") BytePointer name,
                             Pointer data,
                           @Cast("size_t") long size,
                           @Cast("size_t") long max_size);
public static native @Cast("bool") boolean ggml_metal_add_buffer(
        ggml_metal_context ctx,
                       String name,
                             Pointer data,
...
public static native void ggml_metal_set_tensor(ggml_metal_context ctx, ggml_tensor t);

// get data from the device into host memory
public static native void ggml_metal_get_tensor(ggml_metal_context ctx, ggml_tensor t);

// try to find operations that can be run concurrently in the graph
// you should run it again if the topology of your graph changes
public static native void ggml_metal_graph_find_concurrency(ggml_metal_context ctx, ggml_cgraph gf, @Cast("bool") boolean check_mem);

// if the graph has been optimized for concurrently dispatch, return length of the concur_list if optimized
public static native int ggml_metal_if_optimized(ggml_metal_context ctx);

// output the concur_list for ggml_alloc
public static native IntPointer ggml_metal_get_concur_list(ggml_metal_context ctx);

// same as ggml_graph_compute but uses Metal
// creates gf->n_threads command buffers in parallel
public static native void ggml_metal_graph_compute(ggml_metal_context ctx, ggml_cgraph gf);
...
// Targeting ../llama_timings.java
    ...
    public static native int llama_token_to_piece_with_model(
                  @Const llama_model model,
                               @Cast("llama_token") int token,
                                      @Cast("char*") BytePointer buf,
                                      int length);
...
// Targeting ../llama_beam_view.java


// Targeting ../llama_beams_state.java


// Targeting ../llama_beam_search_callback_fn_t.java
    ...
    public static native void llama_beam_search(llama_context ctx, llama_beam_search_callback_fn_t callback, Pointer callback_data, @Cast("size_t") long n_beams, int n_past, int n_predict, int n_threads);
